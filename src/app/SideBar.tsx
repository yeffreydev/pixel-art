  ...
  return (
    <div className="flex flex-col gap-2 w-full h-screen overflow-y-auto p-2">
      <div className="flex-1 flex flex-col gap-3">
        <button className="w-11/12 mx-auto bg-gray-600 bg-opacity-30 text-white rounded-xl py-2 text-left px-2">For You</button>
        ...
        <button className="w-11/12 mx-auto  text-white rounded-md py-2 hover:bg-gray-600 hover:bg-opacity-40 text-left px-2">New Canvas</button>
      </div>
